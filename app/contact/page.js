...
export const metadata = {
  ...
  description: "Get in touch with the HGM team. Inquiries, collaborations, and community connections.",
};
    ...
    <div className={styles.wrapper}>
      <section className={styles.hero}>
        <div className={styles.container}>
          <h1 className="brand-font text-gradient">Connect with HGM</h1>
