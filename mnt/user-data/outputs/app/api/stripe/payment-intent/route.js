...
export async function POST(request) {
  // Rate limit: 8 payment intent requests per minute per IP
  const rlKey = getRateLimitKey(request, 'stripe-pi');
  const rl = checkRateLimit(rlKey, { windowMs: 60_000, maxRequests: 8 });
