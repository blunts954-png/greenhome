...
export const PRODUCTS = [
  ...
  },
  {
    ...
    rating: 5,
    sizes: [],
    details: ['Premium hand-trimmed flower', 'Slow cured', 'Bakersfield pickup only'],
    description: 'Premium reserve flower available for verified 21+ Bakersfield pickup only.',
    pickupOnly: true
  },
  {
    id: 202,
    ...
    rating: 5,
    sizes: [],
    details: ['High-potency concentrate', 'Clean extraction', 'Pickup only'],
    description: 'High-potency HGM wax reserved for verified 21+ Bakersfield pickup.',
    pickupOnly: true
  },
  {
    id: 203,
    ...
    rating: 5,
    sizes: [],
    details: ['100mg THC per pack', 'Lab tested', 'Pickup only'],
    description: 'Signature HGM edibles for verified 21+ Bakersfield pickup.',
    pickupOnly: true
  },
  {
    id: 204,
    ...
    description: 'Ready-to-go disposable pen for verified 21+ Bakersfield pickup.',
    pickupOnly: true
  },
  {
    id: 205,
